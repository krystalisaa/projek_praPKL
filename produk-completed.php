...
WHERE users.id_user = '$id_user' AND pesanan.status = 'Completed'
...
/* 
    .quantity-badge {
      ...
      font-weight: 700;
      font-size: 16px;
      box-shadow: 0 4px 15px rgba(129, 26, 26, 0.3);
    }
...
<body>
  ...
  <div class="container">
    ...
    <div class="order-nav">
      ...
      <a href="produk-completed.php" class="active">
    ...
    ?>
      <div class="order-card">
        ...
        <div class="status-badge">
          <i class="bi bi-check-circle me-2"></i><?= htmlspecialchars($data['status']); ?>
        </div>
    ...
    ?>
      ...
      <div class="empty-state">
        ...
        <div class="empty-message">
          ...
          <p>You currently have no completed orders.</p>
        </div>
      </div>
    <?php
    }
