...
$query_produk = mysqli_query($koneksi, "SELECT p.*, k.nama_kategori FROM produk p JOIN kategori k ON p.id_kategori = k.id_kategori");
?>
...
<head>
    ...
    <title>Kelola Produk - Meijin Meals</title>
...
<body>
    ...
    <main class="main-content">
        <div class="page-header">
            ...
            <p>Kelola semua menu dan produk Meijin Meals dengan mudah</p>
        </div>
        ...
        <div class="action-bar">
            ...
            <div class="total-info">
                ...
                <span>Total Menu: <strong><?php echo mysqli_num_rows($query_produk); ?></strong></span>
            </div>
        </div>
        ...
        <div class="alert alert-success">
            ...
            <strong>Berhasil!</strong> Menu berhasil <?php echo htmlspecialchars($_GET['sukses']); ?>!
        </div>
        <?php endif; ?>
        
        <div class="content-section">
            <div class="section-header">
                <h2><i class="fas fa-list"></i> Daftar Menu & Produk</h2>
            </div>
            ...
            <div class="table-container">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="product-id">#<?php echo str_pad($produk['id_produk'], 3, '0', STR_PAD_LEFT); ?></td>
                            <td>
                                <img src="../asset/menu/<?php echo $produk['foto_produk']; ?>" 
                                     alt="<?php echo htmlspecialchars($produk['nama_produk']); ?>" 
                                     class="product-img">
                            </td>
                            <td class="product-name"><?php echo htmlspecialchars($produk['nama_produk']); ?></td>
                            <td class="product-category"><?php echo htmlspecialchars($produk['nama_kategori']); ?></td>
                            <td class="product-price">Rp <?php echo number_format($produk['harga_produk'], 0, ',', '.'); ?></td>
                            <td>
                                <?php 
                                $stok = $produk['stok'];
                                $stock_class = '';
                                if($stok == 0) $stock_class = 'stock-empty';
                                elseif($stok <= 5) $stock_class = 'stock-low';
                                else $stock_class = 'stock-available';
                                ?>
                            ...
                            <td>
                                <div class="action-buttons">
                                    ...
                                    <a href="hapus_produk.php?id=<?php echo $produk['id_produk']; ?>" 
                                       ...
                                       onclick="return confirm('Yakin ingin menghapus produk <?php echo htmlspecialchars($produk['nama_produk']); ?>?\n\nTindakan ini tidak dapat dibatalkan!')">
                ...
                <div class="empty-state">
                    ...
                    <p style="font-size: 1rem; margin-top: 10px; color: #999;">Klik tombol "Tambah Menu Baru" untuk memulai</p>
                </div>
                <?php endif; ?>
            </div>
        </div>
