...
$query_users = mysqli_query($koneksi, "SELECT * FROM users");
?>
...
<head>
    ...
    <title>Kelola User - Meijin Meals</title>
...
<body>
    ...
    <main class="main-content">
        <div class="page-header">
            ...
            <p>Kelola semua pengguna terdaftar Meijin Meals dengan mudah</p>
        </div>

        <div class="action-bar">
            <div class="total-info">
                <i class="fas fa-info-circle"></i>
                <span>Total User: <strong><?php echo mysqli_num_rows($query_users); ?></strong></span>
            </div>
        </div>
        ...
        <div class="alert alert-success">
            ...
            <strong>Berhasil!</strong> Data user berhasil <?php echo htmlspecialchars($_GET['sukses']); ?>!
        </div>
        <?php endif; ?>
        
        <div class="content-section">
            <div class="section-header">
                <h2><i class="fas fa-list"></i> Daftar Pengguna Terdaftar</h2>
            </div>
            ...
            <div class="table-container">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="user-id">#<?php echo str_pad($users['id_user'], 3, '0', STR_PAD_LEFT); ?></td>
                            <td class="user-name"><?php echo htmlspecialchars($users['nama']); ?></td>
                            <td class="user-username"><?php echo htmlspecialchars($users['username']); ?></td>
                            <td class="user-email"><?php echo htmlspecialchars($users['email']); ?></td>
                            <td class="user-address" title="<?php echo htmlspecialchars($users['alamat']); ?>">
                                <?php echo htmlspecialchars($users['alamat']); ?>
                            </td>
                            <td class="user-phone"><?php echo htmlspecialchars($users['no_hp']); ?></td>
                        </tr>
                        <?php endwhile; ?>
                    </tbody>
                </table>
                ...
                <div class="empty-state">
                    ...
                    <p style="font-size: 1rem; margin-top: 10px; color: #999;">User akan muncul setelah melakukan registrasi</p>
                </div>
                <?php endif; ?>
            </div>
        </div>
